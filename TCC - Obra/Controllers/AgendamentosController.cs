...
namespace TCC___Obra.Controllers
{
    public class AgendamentosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("AgendamentoId,Titulo,Data,Hora,DescricaoAgendamento,Status")] Agendamento agendamento)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("AgendamentoId,Titulo,Data,Hora,DescricaoAgendamento,Status")] Agendamento agendamento)
        {
